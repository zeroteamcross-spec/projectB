...
class CarMapper
{
    public static function toArray(array $car): array
    {
        return [
            ...
            'external_sale_note' => $car['external_sale_note'] ?? null,
            'external_sale_marked_at' => $car['external_sale_marked_at'] ?? null,
            'external_sale_marked_by' => isset($car['external_sale_marked_by']) ? (int) $car['external_sale_marked_by'] : null,
