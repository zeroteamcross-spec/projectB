import{b as l,d as Q,g as w,j as z}from"./chunk-KJYLVAL2.js";import{b as P}from"./chunk-WVHJATZP.js";function T(t){let o=zt(t),e=window.location.pathname+window.location.search;o!==e&&(window.history.pushState(null,"",o),window.dispatchEvent(new PopStateEvent("popstate")))}function zt(t){let o=String(t??"").replace(/^#/,"");return o.startsWith("/")?o:`/${o}`}function oe(t=document){let o=e=>{if(e.defaultPrevented||e.button!==0||e.metaKey||e.ctrlKey||e.shiftKey||e.altKey)return;let n=e.target.closest?.("a[href]");if(!n||n.target&&n.target!=="_self"||n.hasAttribute("download"))return;let i=n.getAttribute("href")||"";if(i.startsWith("#/")){e.preventDefault(),T(i);return}if(i===""||i==="#"){e.preventDefault();return}let r;try{r=new URL(n.href,window.location.href)}catch{return}r.origin!==window.location.origin||r.pathname===window.location.pathname&&r.search===window.location.search&&r.hash||(e.preventDefault(),T(r.pathname+r.search))};return t.addEventListener("click",o),()=>t.removeEventListener("click",o)}var ct=class{constructor({outlet:o,store:e,preloadManager:n,bus:i,notFound:r=null,guard:a=null,resolveMissing:s=null}={}){this.routes=[],this.resolveMissing=s,this.outletResolver=o,this.store=e,this.preloadManager=n,this.bus=i,this.notFound=r,this.guard=a,this.activePage=null,this.jalurTampil=null,this.gulirDitahan=!1,this.handleChange=this.handleChange.bind(this)}add(o){return this.routes.push({...o,pattern:o.pattern??this.compile(o.path)}),this}start(){return"scrollRestoration"in window.history&&(window.history.scrollRestoration="manual"),window.addEventListener("popstate",this.handleChange),this.handleChange(),()=>this.dispose()}navigate(o){T(o)}async handleChange(){let o=this.location(),e=this.match(o.path);if(!e&&typeof this.resolveMissing=="function")try{await this.resolveMissing(o.path)&&(e=this.match(o.path))}catch(m){console.error("Gagal memuat modul rute secara malas.",m)}let n=e?.route??null,i=e?.params??{},r=this.guard?.({route:n,params:i,location:o,router:this,store:this.store,bus:this.bus})??{type:"allow",route:n},a=r.route??n,s=r.params??i;if(r.type==="redirect"){await this.leaveActivePage(),this.bus?.emit("route:guard-redirect",{...r.meta,toPath:r.path}),this.navigate(r.path);return}let c={name:a?.name??null,path:o.path,params:s,query:o.query,route:a,requestedRoute:n,access:r,store:this.store,router:this,bus:this.bus};await this.ensureRoleSnapshot(a),await this.leaveActivePage(),this.store.patchState("app.currentRoute",{name:c.name,path:c.path,params:c.params,query:c.query,route:a?{name:a.name,path:a.path,shell:a.shell??"public",role:a.role??"public",workingStateKey:a.workingStateKey??null}:null},"route:change"),this.bus?.emit("route:change",c);let u=this.jalurTampil!==o.path;if(this.jalurTampil=o.path,this.gulirDitahan=!1,!a){await this.mountPage(this.notFound(c),c),this.pulangkanGulir(u),this.bus?.emit("route:mounted",c);return}a.workingStateKey&&this.store.destroyWorkingState(a.workingStateKey),await this.mountPage(a.page(c),c),this.pulangkanGulir(u),this.bus?.emit("route:mounted",c),this.preloadManager?.hydrateRoute(a,c).then(()=>this.activePage?.__routeName===a.name?this.call(this.activePage,"hydrate",c):null).catch(m=>this.bus?.emit("route:hydrate-error",{error:m,route:a,context:c}))}pulangkanGulir(o){let e=this.gulirDitahan;this.gulirDitahan=!1,!(!o||e)&&window.scrollTo({top:0,left:0,behavior:"instant"})}tahanGulirSekali(){this.gulirDitahan=!0}async leaveActivePage(){this.activePage&&(await this.call(this.activePage,"unmount"),await this.call(this.activePage,"dispose"),this.activePage.__workingStateKey&&this.store.destroyWorkingState(this.activePage.__workingStateKey),this.activePage=null)}async mountPage(o,e){let n=this.outlet(),i=Tt(o);i.__workingStateKey=e.route?.workingStateKey??null,i.__routeName=e.route?.name??null,this.activePage=i,await this.call(i,"bootstrap",e);let r=await i.mount(e);n.replaceChildren(r),await this.call(i,"bindEvents",e)}async ensureRoleSnapshot(o){let e=o?.role??"public";return!this.preloadManager||e==="public"?null:this.preloadManager.boot(e)}async call(o,e,n={}){typeof o?.[e]=="function"&&await o[e](n)}outlet(){return typeof this.outletResolver=="function"?this.outletResolver():this.outletResolver}location(){let o=window.location.pathname||"/",e=window.location.search.replace(/^\?/,"");return{path:this.normalize(o),query:Object.fromEntries(new URLSearchParams(e))}}match(o){for(let e of this.routes){let n=o.match(e.pattern);if(n)return{route:e,params:n.groups??{}}}return null}compile(o){let e=this.normalize(o),n=[],i=e.replace(/:([a-zA-Z_][a-zA-Z0-9_]*)/g,(r,a)=>(n.push(a),`__PARAM_${n.length-1}__`)).replace(/[.*+?^${}()|[\]\\]/g,"\\$&").replace(/__PARAM_(\d+)__/g,(r,a)=>`(?<${n[Number(a)]}>[^/]+)`);return new RegExp(`^${i}$`)}normalize(o){let e=`/${String(o||"/").replace(/^#?\/?/,"")}`;return e==="/"?"/":e.replace(/\/$/,"")}dispose(){window.removeEventListener("popstate",this.handleChange),this.leaveActivePage()}};function Tt(t){return t instanceof Node?{mount:()=>t,hydrate:()=>{},bindEvents:()=>{},unmount:()=>{},dispose:()=>{}}:t}var N={async snapshot(t={},o={}){let e=await P.get(`/notifications/snapshot${Q(t)}`,o);return{unread_count:e.data?.unread_count??0,items:e.data?.items??[]}},async list(t={},o={}){let e=await P.get(`/notifications${Q(t)}`,o);return{items:e.data?.items??[],next_cursor:e.data?.next_cursor??null,unread_count:e.data?.unread_count??0}},async markRead(t,o={}){let e=await P.post(`/notifications/${encodeURIComponent(t)}/read`,{},o);return{id:e.data?.id??t,is_read:!!e.data?.is_read,read_at:e.data?.read_at??null,unread_count:e.data?.unread_count??0}},async markAllRead(t={}){let o=await P.post("/notifications/read-all",{},t);return{updated_count:o.data?.updated_count??0,unread_count:o.data?.unread_count??0}}};var et="modules.notifications",lt=5,g=Object.freeze({unreadCount:0,items:[],workingItems:[],nextCursor:null,activeFilter:"all",isHydrated:!1,isLoading:!1,isMarkingAllRead:!1,markingIds:{},error:null,lastSyncedAt:null,lastMutationAt:null}),p={get(){return $t(),l.get(et,C())},snapshot(){let t=this.get();return{unreadCount:t.unreadCount??0,items:t.items??[],isHydrated:!!t.isHydrated,isLoading:!!t.isLoading,error:t.error??null}},working(){let t=this.get();return{unreadCount:t.unreadCount??0,workingItems:t.workingItems??[],nextCursor:t.nextCursor??null,activeFilter:t.activeFilter??"all",isLoading:!!t.isLoading,isMarkingAllRead:!!t.isMarkingAllRead,markingIds:t.markingIds??{},error:t.error??null}},setSnapshot(t={}){let o=this.get(),e=dt(o),n=ft(q(t.items).slice(0,lt),o,e);return h({...o,unreadCount:mt(t,o,e),items:n,isHydrated:!0,isLoading:!1,error:null,lastSyncedAt:Date.now()},"notifications:snapshot-set"),this.snapshot()},hydrate(t={},{append:o=!1,filter:e=null}={}){let n=this.get(),i=dt(n),r=q(t.items),a=o?J(n.workingItems??[],r):r,s=ft(a,n,i);return h({...n,unreadCount:mt(t,n,i),workingItems:s,nextCursor:t.next_cursor??t.nextCursor??null,activeFilter:e??n.activeFilter??"all",isLoading:!1,error:null,lastSyncedAt:Date.now()},"notifications:hydrate"),this.working()},async loadList(t={},o={}){let e=ot(t.status??this.get().activeFilter??"all"),n=t.cursor??null;this.setLoading(!0);try{let i=await N.list({...t,status:e},o);return this.hydrate(i,{append:!!n,filter:e})}catch(i){throw this.setError(i),i}},setLoading(t){h({...this.get(),isLoading:!!t},"notifications:loading")},setError(t){h({...this.get(),isLoading:!1,isMarkingAllRead:!1,error:Ft(t)},"notifications:error")},applyMarkRead(t,o=$()){let e=this.get(),n=String(t),i=pt(e.items,n)||pt(e.workingItems,n);h({...e,unreadCount:i?Math.max(0,Number(e.unreadCount??0)-1):Number(e.unreadCount??0),items:H(e.items,n,o),workingItems:H(e.workingItems,n,o),markingIds:{...e.markingIds??{},[n]:!0},error:null,lastMutationAt:Date.now()},"notifications:mark-read-optimistic")},completeMarkRead(t,o={}){let e=this.get(),n=String(t),i={...e.markingIds??{}};delete i[n];let r=o.read_at??o.readAt??$();return h({...e,unreadCount:tt(o.unread_count,o.unreadCount,e.unreadCount,0),items:H(e.items,n,r),workingItems:H(e.workingItems,n,r),markingIds:i,error:null,lastSyncedAt:Date.now(),lastMutationAt:Date.now()},"notifications:mark-read-complete"),this.get()},async markRead(t,o={}){let e=String(t??"");if(!e)return this.get();let n=this.get();if(Ot(n,e)?.isRead)return n;this.applyMarkRead(e);try{let r=await N.markRead(e,o);return this.completeMarkRead(e,r)}catch(r){throw this.restore(n,"notifications:mark-read-rollback"),this.setError(r),r}},applyMarkAllRead(t=$()){let o=this.get();h({...o,unreadCount:0,items:X(o.items,t),workingItems:X(o.workingItems,t),isMarkingAllRead:!0,markingIds:{},error:null,lastMutationAt:Date.now()},"notifications:mark-all-optimistic")},completeMarkAllRead(t={}){let o=this.get();return h({...o,unreadCount:tt(t.unread_count,t.unreadCount,0),isMarkingAllRead:!1,error:null,lastSyncedAt:Date.now(),lastMutationAt:Date.now()},"notifications:mark-all-complete"),this.get()},async markAllRead(t={}){let o=this.get();this.applyMarkAllRead();try{let e=await N.markAllRead(t);return this.completeMarkAllRead(e)}catch(e){throw this.restore(o,"notifications:mark-all-rollback"),this.setError(e),e}},restore(t,o="notifications:rollback"){h(t??C(),o)},pushNotification(t){let o=ht(t);if(!o.id)return this.get();let e=this.get(),n=ut(e.items,o.id),i=ut(e.workingItems,o.id),r=!n&&!i&&!o.isRead?1:0,a=J([o],e.items??[]).slice(0,lt),s=Dt(o,e.activeFilter)?J([o],e.workingItems??[]):e.workingItems??[];return h({...e,unreadCount:Math.max(0,Number(e.unreadCount??0)+r),items:a,workingItems:s,error:null,lastSyncedAt:Date.now()},"notifications:push"),this.get()},reset(){h(C(),"notifications:reset")},subscribe(t){return l.subscribe((o,e)=>{t(o.modules?.notifications??C(),e)})}};function $t(){l.get(et,void 0)===void 0&&h(C(),"notifications:init")}function h(t,o){l.patchState(et,Bt(t),o)}function C(){return{unreadCount:g.unreadCount,items:[],workingItems:[],nextCursor:g.nextCursor,activeFilter:g.activeFilter,isHydrated:g.isHydrated,isLoading:g.isLoading,isMarkingAllRead:g.isMarkingAllRead,markingIds:{},error:g.error,lastSyncedAt:g.lastSyncedAt,lastMutationAt:g.lastMutationAt}}function Bt(t={}){return{...C(),...t,unreadCount:Math.max(0,Number(t.unreadCount??0)),items:q(t.items),workingItems:q(t.workingItems),activeFilter:ot(t.activeFilter??"all"),markingIds:{...t.markingIds??{}}}}function q(t=[]){return(Array.isArray(t)?t:[]).map(ht).filter(o=>o.id!=="")}function ht(t={}){let o=t.id??t.notification_id??"",e=t.data??t.data_json??{};return{id:String(o),type:String(t.type??"system_message"),title:String(t.title??""),body:String(t.body??""),data:jt(e)?e:{},linkUrl:t.linkUrl??t.link_url??null,iconKey:t.iconKey??t.icon_key??null,priority:t.priority??"normal",sourceType:t.sourceType??t.source_type??null,sourceId:t.sourceId??t.source_id??null,actorUserId:t.actorUserId??t.actor_user_id??null,isRead:!!(t.isRead??t.is_read??!1),readAt:t.readAt??t.read_at??null,createdAt:t.createdAt??t.created_at??null,expiresAt:t.expiresAt??t.expires_at??null}}function ot(t){return["all","unread","read"].includes(t)?t:"all"}function Dt(t,o="all"){let e=ot(o);return e==="unread"?!t.isRead:e==="read"?t.isRead:!0}function J(t=[],o=[]){let e=new Set;return[...t,...o].filter(n=>{let i=String(n.id??"");return!i||e.has(i)?!1:(e.add(i),!0)})}function ut(t=[],o){let e=String(o);return(t??[]).some(n=>String(n.id)===e)}function pt(t=[],o){let e=String(o);return(t??[]).some(n=>String(n.id)===e&&!n.isRead)}function Ot(t,o){let e=String(o);return[...t.items??[],...t.workingItems??[]].find(n=>String(n.id)===e)??null}function H(t=[],o,e){let n=String(o);return(t??[]).map(i=>String(i.id)===n?{...i,isRead:!0,readAt:i.readAt??e}:i)}function X(t=[],o){return(t??[]).map(e=>({...e,isRead:!0,readAt:e.readAt??o}))}function dt(t={}){return!!(t.isMarkingAllRead||Object.keys(t.markingIds??{}).length)}function mt(t={},o={},e=!1){let n=tt(t.unread_count,t.unreadCount,o.unreadCount,0);return e?Math.min(n,Number(o.unreadCount??0)):n}function ft(t=[],o={},e=!1){if(!e)return t;if(o.isMarkingAllRead)return X(t,$());let n=new Map;return[...o.items??[],...o.workingItems??[]].filter(i=>i?.isRead).forEach(i=>n.set(String(i.id),i.readAt??$())),t.map(i=>{let r=n.get(String(i.id));return r?{...i,isRead:!0,readAt:r}:i})}function tt(...t){for(let o of t){let e=Number(o);if(Number.isFinite(e))return Math.max(0,e)}return 0}function jt(t){return t!==null&&typeof t=="object"&&!Array.isArray(t)}function Ft(t){return t?.message??String(t||"Notifikasi gagal diproses.")}function $(){return new Date().toISOString()}var bt=Object.freeze(["admin","super-admin","seller","buyer","affiliate","login","google-login","auth","api","cars","transactions","profile","notifications","public","showrooms","af","a","s","daftar-showroom","saas-landing","contoh-katalog","health","uploads","assets","tester","app"]);var gt="projectB:buyer:showroom-url",Ut=new RegExp(`^(?:${bt.join("|")})$`);function Kt(t){let o=t.match(/^#?\/s\/([^/?#]+)$/);if(o)return!!o[1];let e=t.match(/^#?\/([^/?#]+)$/);return!!e&&!Ut.test(e[1])}function Wt(t){let o=String(t??"").trim();return o?`/${encodeURIComponent(o)}`:""}function _t(t){if(t?.role!=="buyer")return"";let o=Wt(t.home_showroom_slug);if(!o||typeof window>"u")return o;try{window.localStorage?.setItem(gt,o)}catch{}return o}function yt(){if(typeof window>"u")return"";try{let t=String(window.localStorage?.getItem(gt)??"").trim();return Kt(t)?t:""}catch{return""}}var he={setContext({user:t=null,actor:o=null,impersonation:e=null}={}){l.patchState("auth",{user:t,actor:o,impersonation:e,isAuthenticated:!!t,role:t?.role??"public"},"auth:set-context"),l.patchState("app.activeRole",t?.role??"public","auth:set-role"),_t(t)},setUser(t){this.setContext({user:t,actor:null,impersonation:null})},patchUser(t={}){let o=this.user();if(!t||typeof t!="object"||Array.isArray(t))return o;if(!o)return Object.keys(t).length?(this.setContext({user:t,actor:this.actor(),impersonation:this.impersonation()}),t):o;let e={...o,...t};return this.setContext({user:e,actor:this.actor(),impersonation:this.impersonation()}),e},user(){return l.get("auth.user",null)},actor(){return l.get("auth.actor",null)},impersonation(){return l.get("auth.impersonation",null)},role(){return l.get("auth.role","public")},isAuthenticated(){return l.get("auth.isAuthenticated",!1)}};var Ht=45e3,F=45e3,B=null,Y="",D=null,O=l,vt=F,nt=!1,x={setSnapshot(t={}){return p.setSnapshot(t)},async loadSnapshot(t={},o={}){let{store:e=l,...n}=o;p.setLoading(!0);try{let i=await N.snapshot(t,n);return Y=M(e.get?.("auth",null)),p.setSnapshot(i)}catch(i){throw p.setError(i),i}},async ensureSnapshot({force:t=!1,ttlMs:o=Ht,store:e=l}={}){let n=e?.get?.("auth",null)??l.get("auth",null);if(!V(n))return p.snapshot();let i=M(n),r=p.get(),a=Number(r.lastSyncedAt??0),s=!!r.isHydrated&&Y===i&&a>0&&Date.now()-a<o;return!t&&s?p.snapshot():(B&&Y===i||(Y=i,B=this.loadSnapshot({},{store:e}).catch(c=>(p.setError(c),p.snapshot())).finally(()=>{B=null})),B)},hydrate(t={},o={}){return p.hydrate(t,o)},async loadList(t={},o={}){return p.loadList(t,o)},async markRead(t,o={}){return p.markRead(t,o)},async markAllRead(t={}){return p.markAllRead(t)},pushNotification(t){return p.pushNotification(t)},reset(){p.reset()},snapshot(){return p.snapshot()},working(){return p.working()},subscribe(t){return p.subscribe(t)},startPolling({intervalMs:t=F,store:o=l,immediate:e=!1}={}){return O=o??l,vt=qt(t),nt=!0,!G(O)||j()?(this.stopPolling({keepEnabled:!0}),!1):(D!==null||(D=window.setInterval(()=>{this.pollSnapshot({store:O})},vt),e&&this.pollSnapshot({store:O})),!0)},stopPolling({keepEnabled:t=!1}={}){D!==null&&(window.clearInterval(D),D=null),t||(nt=!1)},restartPolling(t={}){return this.stopPolling(),this.startPolling(t)},pollSnapshot({store:t=O}={}){return!G(t)||j()?Promise.resolve(p.snapshot()):this.ensureSnapshot({force:!0,store:t})},bindVisibilityLifecycle({store:t=l,intervalMs:o=F}={}){if(typeof document>"u")return()=>{};let e=()=>{if(j()){this.stopPolling({keepEnabled:!0});return}nt&&G(t)&&this.startPolling({store:t,intervalMs:o,immediate:!0})};return document.addEventListener("visibilitychange",e),()=>document.removeEventListener("visibilitychange",e)},bindAuthReset(t){let o=M(t?.get("auth",null));return t?.subscribe?.(e=>{let n=M(e.auth);o!==n&&(o=n,p.reset())})??(()=>{})},bindAuthLifecycle(t=l){let o=M(t?.get("auth",null));return t?.subscribe?.(e=>{let n=M(e.auth);o!==n&&(o=n,p.reset(),V(e.auth)&&this.ensureSnapshot({force:!0,store:t}))})??(()=>{})},bindRealtimeLifecycle(t=l,{intervalMs:o=F}={}){let e=[];e.push(this.bindAuthLifecycle(t)),e.push(this.bindVisibilityLifecycle({store:t,intervalMs:o})),G(t)&&!j()&&this.startPolling({store:t,intervalMs:o,immediate:!0});let n=t?.subscribe?.(i=>{if(!V(i.auth)){this.stopPolling();return}j()||this.startPolling({store:t,intervalMs:o,immediate:!0})})??null;return n&&e.push(n),()=>{e.splice(0).forEach(i=>i?.()),this.stopPolling()}}};function M(t=null){let o=t?.user?.id??t?.user?.user_id??"",e=t?.role??t?.user?.role??"public";return`${o}:${e}`}function V(t=null){let o=t?.role??t?.user?.role??"public",e=t?.user?.id??t?.user?.user_id??null;return!!(t?.isAuthenticated&&e&&o!=="public")}function G(t=l){return V(t?.get?.("auth",null)??l.get("auth",null))}function j(){return typeof document<"u"&&document.visibilityState==="hidden"}function qt(t){let o=Number(t);return Number.isFinite(o)?Math.max(3e4,Math.min(o,6e4)):F}var Yt={payment:"creditCard",transaction:"shoppingBag",message:"message",offer:"tag",security:"shield",commission:"commission",settlement:"wallet",inspection:"clipboard",listing:"car",system:"bell",transaction_paid:"creditCard",transaction_new:"shoppingBag",transaction_processing:"shoppingBag",transaction_completed:"circleCheck",message_new:"message",security_alert:"shield",commission_accrued:"commission",settlement_paid:"wallet",inspection_needed:"clipboard",listing_approved:"car",listing_rejected:"triangleWarning",system_message:"bell"},Gt={payment:"blue",transaction:"red",message:"blue",offer:"green",security:"purple",commission:"green",settlement:"green",inspection:"blue",listing:"blue",system:"blue",transaction_paid:"blue",transaction_new:"red",transaction_processing:"red",transaction_completed:"green",message_new:"blue",security_alert:"purple",commission_accrued:"green",settlement_paid:"green",inspection_needed:"blue",listing_approved:"green",listing_rejected:"red",system_message:"blue"};function wt({item:t={}}={}){let o=String(t.iconKey??t.icon_key??t.type??"system").trim()||"system",e=Yt[o]??"bell",n=Gt[o]??"blue",i=document.createElement("span");return i.className=`pb-notification-icon pb-notification-icon--${n}`,i.setAttribute("aria-hidden","true"),i.append(w(e,{className:"pb-notification-icon__svg"})),i}function L(t,o){let e=String(t??"").trim();if(!e)return;let n=e.startsWith("#")?e.slice(1):e,i=n.startsWith("/")?n:`/${n}`;if(typeof o=="function"){o(i);return}T(i)}function kt({item:t={},onNavigate:o=null,onClose:e=null}={}){let n=document.createElement("article");n.className="pb-notification-item",n.id=`ntf_item_${Zt(t.id)}`;let i=document.createElement("button");i.type="button",i.className="pb-notification-item__button",i.addEventListener("click",async()=>{let c=!xt(t);try{c&&t.id&&await x.markRead(t.id);let u=t.linkUrl??t.link_url??"";u&&(e?.(),L(u,o))}catch(u){z(u.message||"Gagal menandai notifikasi.",{type:"error"})}});let r=document.createElement("span");r.className=xt(t)?"pb-notification-item__dot pb-notification-item__dot--hidden":"pb-notification-item__dot",r.setAttribute("aria-hidden","true");let a=document.createElement("section");a.className="pb-notification-item__content",a.append(it("h3",t.title||"Notifikasi"),it("p",t.body||"Aktivitas baru tersedia."));let s=it("span",Vt(t.createdAt??t.created_at));return s.className="pb-notification-item__time",i.append(r,wt({item:t}),a,s),n.append(i),n}function xt(t={}){return!!(t.isRead??t.is_read)}function Vt(t){if(!t)return"";let o=new Date(t).getTime();if(!Number.isFinite(o))return"";let e=Math.max(0,Math.floor((Date.now()-o)/1e3));if(e<60)return"Baru saja";let n=Math.floor(e/60);if(n<60)return`${n}m lalu`;let i=Math.floor(n/60);if(i<24)return`${i}j lalu`;let r=Math.floor(i/24);return r<7?`${r}h lalu`:new Intl.DateTimeFormat("id-ID",{day:"2-digit",month:"short"}).format(new Date(o))}function it(t,o){let e=document.createElement(t);return e.textContent=o??"",e}function Zt(t){return String(t??"unknown").toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"")||"unknown"}function At({id:t="ntf_popover",open:o=!1,snapshot:e={},onClose:n=null,onNavigate:i=null}={}){let r=document.createElement("section");r.id=t,r.className=o?"pb-notification-popover is-open":"pb-notification-popover",r.hidden=!o,r.setAttribute("aria-hidden",o?"false":"true");let a=document.createElement("span");a.className="pb-notification-popover__pointer",a.setAttribute("aria-hidden","true");let s=document.createElement("section");s.className="pb-notification-popover__header";let c=document.createElement("h2");c.className="pb-notification-popover__title",c.textContent="Notifikasi";let u=document.createElement("button");u.type="button",u.className="pb-notification-popover__mark",u.textContent=e.isMarkingAllRead?"Memproses...":"Tandai semua dibaca",u.disabled=!!(e.isMarkingAllRead||!Number(e.unreadCount??0)),u.addEventListener("click",async()=>{try{await x.markAllRead(),z("Semua notifikasi ditandai dibaca.",{type:"success"})}catch(R){z(R.message||"Gagal menandai semua notifikasi.",{type:"error"})}}),s.append(c,u);let m=document.createElement("section");m.className="pb-notification-popover__list";let _=Array.isArray(e.items)?e.items.slice(0,5):[];e.error?m.append(St({title:"Notifikasi belum bisa dimuat",body:"Coba lagi nanti.",icon:"triangleWarning"})):_.length?_.forEach(R=>{m.append(kt({item:R,onNavigate:i,onClose:n}))}):m.append(St({title:"Belum ada notifikasi",body:"Aktivitas penting akan muncul di sini.",icon:"bell"}));let b=document.createElement("button");b.type="button",b.className="pb-notification-popover__footer",b.addEventListener("click",()=>{n?.(),L("/notifications",i)});let y=document.createElement("span");return y.className="pb-notification-popover__footer-label",y.append(rt("bell","pb-notification-popover__footer-icon"),at("span","Lihat semua notifikasi")),b.append(y,rt("chevronRight","pb-notification-popover__chevron")),r.append(a,s,m,b),r}function St({title:t,body:o,icon:e}){let n=document.createElement("section");return n.className="pb-notification-popover__state",n.append(rt(e,"pb-notification-popover__state-icon"),at("h3",t),at("p",o)),n}function rt(t,o){let e=document.createElement("span");return e.className=o,e.append(w(t,{className:"block h-4 w-4 leading-none"})),e}function at(t,o){let e=document.createElement(t);return e.textContent=o??"",e}var Et="pb-notification-components-style",Rt="notification_overlay_root";function Fe({idPrefix:t="ntf",onNavigate:o=null,compact:e=!1,subscribe:n=!0,withBackdrop:i=!1}={}){Jt();let r=document.createElement("section");r.className="pb-notification-bell",r.id=`${t}_notification_host`;let a=!1,s=!1,c=null,u=null,m=null,_=null,b=null,y=()=>{a&&(a=!1,Z(),K(),U())},R=()=>y(),U=()=>{if(s)return;if(Z(),K(),!l.get("auth",{})?.isAuthenticated){r.hidden=!0,r.classList.remove("is-open"),r.replaceChildren(),a=!1;return}r.hidden=!1,r.classList.toggle("is-open",a);let v=x.snapshot(),k=x.working(),I={...v,isMarkingAllRead:k.isMarkingAllRead},d=Number(I.unreadCount??0),S=`${t}_ntf_popover`,Pt=`${t}_ntf_backdrop`,f=document.createElement("button");if(f.id=`${t}_ntf_bell_button`,f.type="button",f.className=e?"pb-notification-bell__button pb-notification-bell__button--compact":"pb-notification-bell__button",f.setAttribute("aria-label",a?"Tutup notifikasi":"Buka notifikasi"),f.setAttribute("aria-haspopup","dialog"),f.setAttribute("aria-expanded",a?"true":"false"),f.setAttribute("aria-controls",S),f.addEventListener("click",()=>{a=!a,U()}),f.append(w("bell",{className:"pb-notification-bell__icon"})),d>0){let E=document.createElement("span");E.id=`${t}_ntf_bell_badge`,E.className=d>9?"pb-notification-bell__badge pb-notification-bell__badge--count":"pb-notification-bell__badge",E.textContent=d>99?"99+":d>9?String(d):"",E.setAttribute("aria-label",`${d} notifikasi belum dibaca`),f.append(E)}let A=a?At({id:S,open:a,snapshot:I,onClose:y,onNavigate:E=>L(E,o)}):null;i&&A?(A.classList.add("pb-notification-popover--portal"),r.replaceChildren(f),Lt(Pt,A,f),st({button:f,popover:A})):A?(r.replaceChildren(f,A),st({button:f,popover:A})):r.replaceChildren(f)};return n&&(c=x.subscribe(U)),U(),window.addEventListener("popstate",R),r.dispose=()=>{s=!0,Z(),K(),c?.(),window.removeEventListener("popstate",R)},r;function st({button:W,popover:v}){if(!a)return;let k=I=>{let d=I.target;d instanceof Node&&(v.contains(d)||W.contains(d)||y())};document.addEventListener("pointerdown",k,!0),u=()=>document.removeEventListener("pointerdown",k,!0)}function Z(){u?.(),u=null}function Lt(W,v,k){if(!a||!i||typeof document>"u"){K();return}let I=Qt(),d=document.createElement("button");d.id=W,d.type="button",d.className="pb-notification-popover__backdrop is-open",d.hidden=!1,d.setAttribute("aria-hidden","true"),d.tabIndex=-1,d.addEventListener("click",y),I.append(d,v),_=d,b=v,It(k,v);let S=()=>It(k,v);window.addEventListener("resize",S,{passive:!0}),window.addEventListener("scroll",S,{passive:!0,capture:!0}),m=()=>{window.removeEventListener("resize",S),window.removeEventListener("scroll",S,{capture:!0})}}function K(){m?.(),m=null,_?.remove(),_=null,b?.remove(),b=null}}function Qt(){let t=document.getElementById(Rt);return t||(t=document.createElement("div"),t.id=Rt,t.className="pb-notification-overlay-root",document.body.append(t),t)}function It(t,o){if(!t?.isConnected||!o?.isConnected)return;let e=t.getBoundingClientRect(),n=window.innerWidth||document.documentElement.clientWidth||0,i=window.innerHeight||document.documentElement.clientHeight||0,r=n<=520,a=n<=374?8:16,s=Math.max(280,Math.min(410,n-a*2)),c=e.left+e.width/2,u=r?Math.max(72,e.bottom+12):Math.max(a,e.bottom+16),m=r?a:Nt(e.right-s,a,Math.max(a,n-a-s)),_=Nt(m+s-c-14,24,Math.max(24,s-52)),b=Math.max(220,i-u-a);o.style.setProperty("--pb-notification-popover-top",`${Math.round(u)}px`),o.style.setProperty("--pb-notification-popover-left",`${Math.round(m)}px`),o.style.setProperty("--pb-notification-popover-width",`${Math.round(s)}px`),o.style.setProperty("--pb-notification-popover-max-height",`${Math.round(b)}px`),o.style.setProperty("--pb-notification-popover-pointer-right",`${Math.round(_)}px`)}function Nt(t,o,e){return Math.min(Math.max(t,o),e)}function Jt(){if(document.getElementById(Et))return;let t=document.createElement("style");t.id=Et,t.textContent=`
  ...
  `,document.head.append(t)}export{T as a,oe as b,ct as c,bt as d,yt as e,he as f,g,x as h,wt as i,L as j,Fe as k,Xt as l,He as m};
