...
export function SellerShowroomPanel({ summary = {} } = {}) {
  ...
  section.className = "grid min-w-0 gap-4 rounded-[1.75rem] border border-white/80 bg-[linear-gradient(135deg,rgba(255,255,255,0.92),rgba(240,253,250,0.76),rgba(255,247,237,0.70))] p-4 shadow-[0_18px_52px_rgba(15,23,42,0.08)] backdrop-blur-xl transition-shadow duration-150 sm:p-5";
  ...
  copy.append(
    textNode("p", "text-[11px] font-black uppercase tracking-[0.16em] text-orange-700", "Showroom readiness"),
