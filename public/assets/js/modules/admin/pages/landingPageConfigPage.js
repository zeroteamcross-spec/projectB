...
function hero() {
  ...
  preview.append(
    textNode("p", "text-xs font-black uppercase tracking-[0.14em] text-gray-500", "Route target"),
    textNode("p", "text-xl font-black text-gray-950", "#/"),
  );
...
function actionPanel(state, actions) {
  ...
  panel.append(textNode("p", "text-sm font-semibold leading-6 text-gray-600", "Perubahan berlaku untuk route #/ setelah konfigurasi tersimpan."));
