...
function carsHero({ cars, filteredCars, isForm }) {
  ...
  copy.append(
    ...
    textNode("h1", "max-w-3xl text-2xl font-black leading-tight tracking-normal text-gray-950 sm:text-3xl", isForm ? "Form listing mobil" : "Katalog Mobil"),
...
function adminSellerSelector(runtime) {
  ...
  select.className = "min-h-11 min-w-0 rounded-[1rem] border border-[var(--pb-form-border)] bg-[var(--pb-form-input-bg)] px-4 py-2.5 text-xs font-semibold text-[var(--pb-text)] outline-none transition duration-150 focus:border-[var(--pb-form-focus)] focus:ring-2 focus:ring-[var(--pb-form-focus)]";
...
function message(color, text) {
  ...
  node.className = `rounded-[1rem] border px-4 py-3 text-xs font-semibold ${palette}`;
