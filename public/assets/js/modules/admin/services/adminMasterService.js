...
const DEFAULT_SIDEBAR_SEED = [
  ...
  sidebarSeed("seller.affiliates", "seller", "Affiliate", "#/seller/affiliates", "affiliate", 40),
  sidebarSeed("seller.affiliate_commissions", "seller", "Komisi Affiliate", "#/seller/affiliate-commissions", "commission", 50),
  sidebarSeed("seller.transactions", "seller", "Transaksi", "#/seller/transactions", "transaction", 60),
  sidebarSeed("affiliate.dashboard", "affiliate", "Dashboard Affiliate", "#/affiliate", "affiliate", 10),
