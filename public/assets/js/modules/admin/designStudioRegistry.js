export const DESIGN_STUDIO_PREVIEW_ROUTES = [
  ...
  { id: "affiliate-dashboard", label: "Affiliate Dashboard", route: "/#/affiliate", roleContext: "affiliate_admin", viewportPresets: ["mobile", "desktop"] },
  { id: "affiliate-ledger", label: "Affiliate Ledger", route: "/#/affiliate/ledger", roleContext: "affiliate_admin", viewportPresets: ["mobile", "desktop"] },
  { id: "affiliate-settlements", label: "Affiliate Settlements", route: "/#/affiliate/settlements", roleContext: "affiliate_admin", viewportPresets: ["mobile", "desktop"] },
...
export const DESIGN_STUDIO_REGISTRY = {
  ...
  "affiliate.mobile.footer": {
    label: "Affiliate Mobile Footer",
    group: "Affiliate Layout",
    description: "Footer navigasi mobile untuk affiliate.",
    editable: true,
    allowedStyles: ["background", "height", "borderTopRadius", "iconSize", "fontSize", "textColor"],
    responsive: true,
