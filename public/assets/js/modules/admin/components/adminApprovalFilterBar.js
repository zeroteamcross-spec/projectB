...
export function AdminApprovalFilterBar({ filters = {}, counts = {}, onSubmit = null } = {}) {
  ...
  form.className = `grid gap-4 ${tw.section.toolbar} border-[var(--pb-card-border)] bg-[linear-gradient(135deg,rgba(255,255,255,0.94),rgba(234,244,249,0.72),rgba(250,244,237,0.70))] lg:grid-cols-[minmax(0,1.2fr)_180px_220px_auto]`;
