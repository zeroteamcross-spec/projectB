...
export function AdminUsersFilterBar({ filters = {}, counts = {}, onSubmit = null } = {}) {
  ...
  form.className = `grid min-w-0 gap-4 ${tw.section.toolbar} border-white/80 bg-[linear-gradient(135deg,rgba(255,255,255,0.94),rgba(239,246,255,0.72),rgba(255,247,237,0.70))] lg:grid-cols-[minmax(0,1.2fr)_180px_220px_auto]`;
  ...
  copy.append(
    textBlock("text-[11px] font-black uppercase tracking-[0.16em] text-blue-700", "User filter"),
    textBlock("text-sm leading-6 text-gray-600", "Saring role, status, dan keyword supaya review operasional tetap cepat dibaca."),
  );
