...
export function renderImpersonationBanner(host, store, { redirectTo = "#/admin" } = {}) {
  ...
  panel.className = "flex min-w-0 flex-col gap-3 rounded-2xl border border-amber-300 bg-amber-50 px-4 py-3 text-sm text-amber-900 shadow-sm md:flex-row md:items-center md:justify-between";
