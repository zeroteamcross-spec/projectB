const DESIGN_STUDIO_HOOK_REGISTRY = [
  ...
  entry("shell.app.header", "Header aplikasi", "Header global untuk halaman buyer, seller, admin, dan affiliate.", "Shared layout", ["shell"], ["shell.appHeaderBg", "brand.appName", "brand.logoIcon"]),
  ...
  entry("public.affiliate.banner", "Banner affiliate", "Banner context affiliate aktif di public flow.", "Public catalog", ["surface", "colors"], ["surface.panelBg", "colors.accent"]),
  ...
  entry("seller.affiliates.summary", "Ringkasan affiliate seller", "Card jumlah affiliate seller.", "Seller", ["surface"], ["surface.cardBg", "surface.cardBorder"]),
  entry("seller.affiliates.list", "Daftar affiliate seller", "List affiliate seller beserta CTA landing.", "Seller", ["surface"], ["surface.cardBg", "surface.cardBorder"]),
  entry("seller.affiliates.form", "Form affiliate seller", "Form create/edit affiliate seller.", "Seller", ["form", "surface"], ["form.inputBg", "form.controlBorder", "button.primaryFrom"]),
  entry("seller.commissions.summary", "Ringkasan komisi seller", "Summary komisi affiliate seller.", "Seller", ["surface"], ["surface.cardBg", "surface.cardBorder"]),
  ...
  entry("admin.settlements.summary", "Ringkasan settlement admin", "Summary settlement affiliate di admin.", "Admin", ["surface"], ["surface.cardBg", "surface.cardBorder"]),
  ...
  entry("affiliate.dashboard.summary", "Ringkasan dashboard affiliate", "Ringkasan utama dashboard affiliate.", "Affiliate", ["surface"], ["surface.cardBg", "surface.cardBorder"]),
  entry("affiliate.dashboard.quick_actions", "Quick actions affiliate", "Shortcut aksi affiliate untuk landing dan laporan.", "Affiliate", ["surface"], ["surface.panelBg", "button.secondaryBg"]),
  entry("affiliate.dashboard.identity", "Identitas affiliate", "Panel identitas dan landing affiliate.", "Affiliate", ["surface"], ["surface.cardBg", "surface.cardBorder"]),
  entry("affiliate.dashboard.activity", "Aktivitas affiliate", "Panel ringkas aktivitas affiliate di dashboard.", "Affiliate", ["surface"], ["surface.cardBg", "surface.cardBorder"]),
  entry("affiliate.dashboard.owner", "Owner panel affiliate", "Panel informasi owner/seller affiliate.", "Affiliate", ["surface"], ["surface.panelBg", "surface.cardBorder"]),
  entry("affiliate.activity.summary", "Ringkasan activity affiliate", "Summary click/activity affiliate.", "Affiliate", ["surface"], ["surface.cardBg", "surface.cardBorder"]),
  entry("affiliate.activity.list", "Daftar click affiliate", "Daftar click activity affiliate.", "Affiliate", ["surface"], ["surface.cardBg", "surface.cardBorder"]),
  entry("affiliate.ledger.summary", "Ringkasan ledger affiliate", "Summary ledger komisi affiliate.", "Affiliate", ["surface"], ["surface.cardBg", "surface.cardBorder"]),
  entry("affiliate.ledger.list", "Daftar ledger affiliate", "Daftar ledger komisi affiliate.", "Affiliate", ["surface"], ["surface.cardBg", "surface.cardBorder"]),
  entry("affiliate.settlements.summary", "Ringkasan settlement affiliate", "Summary payout baseline affiliate.", "Affiliate", ["surface"], ["surface.cardBg", "surface.cardBorder"]),
  entry("affiliate.settlements.eligible", "Ledger eligible affiliate", "Daftar ledger yang eligible untuk settlement.", "Affiliate", ["surface"], ["surface.cardBg", "surface.cardBorder"]),
  entry("affiliate.settlements.history", "Riwayat settlement affiliate", "Daftar riwayat settlement affiliate.", "Affiliate", ["surface"], ["surface.cardBg", "surface.cardBorder"]),
];
