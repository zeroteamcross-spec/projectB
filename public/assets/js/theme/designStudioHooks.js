const DESIGN_STUDIO_HOOK_REGISTRY = [
  ...
  entry("shell.app.header", "Header aplikasi", "Header global untuk halaman buyer, showroom, admin, dan marketing.", "Shared layout", ["shell"], ["shell.appHeaderBg", "brand.appName", "brand.logoIcon"]),
  ...
  entry("shared.section_header", "Section header", "Header judul halaman/module yang dipakai lintas level user.", "Shared elements", ["shell", "layout"], ["colors.text", "colors.textMuted"]),
  ...
  entry("public.car_detail.seller_summary", "Ringkasan showroom", "Panel informasi showroom di detail mobil.", "Public detail", ["surface"], ["surface.panelBg", "surface.cardBorder"]),
  ...
  entry("seller.dashboard.showroom", "Panel showroom", "Ringkasan showroom pada dashboard showroom.", "Seller", ["surface"], ["surface.cardBg", "surface.cardBorder"]),
  entry("seller.dashboard.summary", "Ringkasan dashboard showroom", "Stat card dashboard showroom.", "Seller", ["surface"], ["surface.cardBg", "surface.cardBorder"]),
  entry("seller.dashboard.tasks", "Task launcher showroom", "Shortcut tugas utama showroom.", "Seller", ["surface"], ["surface.panelBg", "button.secondaryBg"]),
  entry("seller.affiliates.summary", "Ringkasan marketing showroom", "Card jumlah marketing showroom.", "Seller", ["surface"], ["surface.cardBg", "surface.cardBorder"]),
  entry("seller.affiliates.list", "Daftar marketing showroom", "List marketing showroom beserta CTA landing.", "Seller", ["surface"], ["surface.cardBg", "surface.cardBorder"]),
  entry("seller.affiliates.form", "Form marketing showroom", "Form create/edit marketing showroom.", "Seller", ["form", "surface"], ["form.inputBg", "form.controlBorder", "button.primaryFrom"]),
  entry("seller.commissions.summary", "Ringkasan komisi showroom", "Summary komisi marketing showroom.", "Seller", ["surface"], ["surface.cardBg", "surface.cardBorder"]),
  ...
  entry("seller.commissions.global_form", "Form rule global komisi", "Form rule komisi global showroom.", "Seller", ["form", "surface"], ["form.inputBg", "form.controlBorder", "button.primaryFrom"]),
  ...
  entry("affiliate.dashboard.owner", "Owner panel marketing", "Panel informasi owner/showroom marketing.", "Marketing", ["surface"], ["surface.panelBg", "surface.cardBorder"]),
