...
export const tw = {
  ...
  layout: {
    ...
    brand: "text-xl font-bold tracking-normal text-white",
    sidebarBrandBlock: "mb-[var(--pb-space-xl)] grid gap-1",
    sidebarTagline: "text-xs font-medium text-white/70",
    ...
    nav: "grid gap-2",
    navLink: "flex min-w-0 items-center gap-3 rounded-[var(--pb-radius-xl)] px-3 py-2.5 text-sm font-semibold text-[var(--pb-shell-nav-text)] no-underline transition hover:bg-white/12 focus:outline-none focus:ring-2 focus:ring-white/40",
    ...
    publicMark: "grid h-10 w-10 shrink-0 place-items-center rounded-[var(--pb-radius-xl)] bg-[linear-gradient(135deg,var(--pb-brand-primary),var(--pb-brand-accent),var(--pb-brand-secondary))] text-sm font-bold text-white shadow-[var(--pb-shadow-card)]",
    publicActions: "flex min-w-0 items-center gap-2",
    publicActionButton: "inline-flex min-h-10 max-w-full items-center justify-center rounded-[var(--pb-radius-xl)] border border-[var(--pb-border-strong)] bg-[var(--pb-btn-secondary-bg)] px-3 py-2 text-sm font-semibold text-[var(--pb-btn-secondary-text)] no-underline shadow-[var(--pb-shadow-soft)] transition hover:brightness-95",
    ...
    appHeaderTitle: "text-sm font-semibold text-[var(--pb-text-muted)]",
    rolePill: "inline-flex max-w-full items-center rounded-full border border-[var(--pb-border)] bg-[color-mix(in_srgb,var(--pb-brand-primary)_12%,white)] px-3 py-1 text-xs font-semibold uppercase text-[var(--pb-brand-secondary)]",
    contentBackdrop: "relative",
  },
  text: {
    muted: "text-[var(--pb-text-muted)]",
    subtle: "text-[var(--pb-text-strong)]",
    title: "break-words text-2xl font-bold leading-tight tracking-normal text-[var(--pb-text)] md:text-3xl",
    sectionTitle: "break-words text-xl font-bold tracking-normal text-[var(--pb-text)]",
    eyebrow: "text-xs font-bold uppercase tracking-normal text-[var(--pb-brand-secondary)]",
  ...
  surface: {
    ...
    insetGrid: "rounded-[var(--pb-radius-xl)] bg-[var(--pb-surface-inset)] p-3 text-sm",
    ...
    successInset: "rounded-[var(--pb-radius-xl)] border border-[color-mix(in_srgb,var(--pb-success)_30%,white)] bg-[color-mix(in_srgb,var(--pb-success)_12%,white)] p-3 text-sm",
  ...
  form: {
    label: "grid gap-1 text-sm font-medium text-[var(--pb-text-strong)]",
    control: "max-h-[50px] min-h-8 min-w-0 w-full rounded-[var(--pb-radius-xl)] border border-[var(--pb-form-border)] bg-[var(--pb-form-input-bg)] px-3 py-2 text-sm text-[var(--pb-text)] outline-none transition focus:border-[var(--pb-form-focus)] focus:ring-2 focus:ring-[var(--pb-form-focus)]",
    checkLabel: "inline-flex items-center gap-2 text-sm font-medium text-[var(--pb-text-strong)]",
    ...
    searchInput: "min-h-12 min-w-0 rounded-[var(--pb-radius-xl)] border-0 bg-transparent px-4 text-base text-[var(--pb-text)] outline-none placeholder:text-[var(--pb-text-muted)]",
    choiceActive: "rounded-[var(--pb-radius-xl)] border border-[var(--pb-brand-primary)] bg-[color-mix(in_srgb,var(--pb-brand-primary)_10%,white)] p-3 text-sm text-[var(--pb-text)]",
  ...
  badge: {
    base: "inline-flex max-w-full w-fit items-center break-words rounded-full px-2.5 py-1 text-[11px] font-semibold tracking-normal",
  ...
  tabs: {
    ...
    active: "max-w-full break-words rounded-[var(--pb-radius-md)] bg-[linear-gradient(135deg,var(--pb-btn-primary-from),var(--pb-btn-primary-to))] px-3 py-2 text-sm font-semibold text-white",
    idle: "max-w-full break-words rounded-[var(--pb-radius-md)] border border-[var(--pb-border-strong)] bg-[var(--pb-surface-card)] px-3 py-2 text-sm font-semibold text-[var(--pb-text)]",
  },
  interactive: {
    primaryLink: "inline-flex min-h-10 items-center justify-center rounded-[var(--pb-radius-xl)] border border-transparent bg-[linear-gradient(135deg,var(--pb-btn-primary-from),var(--pb-btn-primary-to))] px-4 py-2 text-sm font-semibold text-white no-underline transition hover:brightness-95",
    pillActive: "max-w-full break-words rounded-full bg-[linear-gradient(135deg,var(--pb-chip-active-from),var(--pb-chip-active-to))] px-4 py-2 text-sm font-semibold text-white shadow-[var(--pb-shadow-card)]",
    pillIdle: "max-w-full break-words rounded-full border border-[var(--pb-border)] bg-[var(--pb-chip-bg)] px-4 py-2 text-sm font-semibold text-[var(--pb-chip-text)] shadow-[var(--pb-shadow-soft)]",
  ...
  alert: {
    error: "rounded-[var(--pb-radius-xl)] border border-[var(--pb-error-border)] bg-[var(--pb-error-bg)] px-4 py-4 text-sm text-[var(--pb-danger)] shadow-[var(--pb-shadow-card)] backdrop-blur",
    errorMeta: "text-sm text-[var(--pb-danger)]",
  },
};
