...
export const tw = {
  ...
  layout: {
    ...
    sidebar: "hidden min-w-0 border-r border-white/15 bg-[linear-gradient(160deg,rgba(11,31,58,0.94),rgba(22,38,74,0.86))] px-3 py-4 text-[var(--pb-shell-nav-text)] shadow-[0_26px_80px_rgba(15,23,42,0.28)] backdrop-blur-2xl md:sticky md:top-0 md:block md:h-screen md:overflow-y-auto md:py-6 xl:px-6",
    ...
    nav: "grid gap-2",
    navLink: "flex min-w-0 items-center gap-3 rounded-[var(--pb-radius-xl)] border border-transparent px-3 py-2.5 text-xs font-semibold text-[var(--pb-shell-nav-text)] no-underline transition hover:border-white/15 hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/40",
    navLinkActive: "border-white/20 bg-white/14 shadow-[0_10px_28px_rgba(15,23,42,0.18)] ring-1 ring-white/10",
  ...
  surface: {
    card: "rounded-[var(--pb-radius-xl)] border border-gray-200 bg-[var(--pb-surface-card)] p-4 shadow-[var(--pb-shadow-card)] backdrop-blur",
    raisedCard: "p-[10px] rounded-[var(--pb-radius-2xl)] border border-gray-200 bg-[var(--pb-surface-card)] shadow-[var(--pb-shadow-card)] backdrop-blur",
