...
export class ProjectBApp {
  ...
  async bootstrap() {
    ...
    /**
     * Baris-baris di bawah ini SEMPAT dilepas jadi tidak ditunggu, dengan
     * anggapan Router sudah punya jaring pengamannya sendiri
     * (resolveMissing() dan ensureRoleSnapshot()) untuk memuat manifest dan
     * preload yang belum siap. Anggapan itu salah: muatManifest() dan
     * PreloadManager.boot() menandai targetnya sebagai "sedang/sudah
     * diproses" secara SINKRON, sebelum await pertama. Begitu baris ini
     * dilepas tanpa ditunggu, jaring pengaman Router memeriksa penanda itu,
     * melihatnya sudah ada, dan mengira pekerjaannya sudah beres -- padahal
     * importnya baru saja dimulai. Router pun melanjutkan dengan rute yang
     * belum benar-benar termuat, dan #/admin (atau #/seller, #/buyer) pada
     * pemuatan pertama jatuh ke halaman publik alih-alih dashboard atau
     * redirect login-nya. Makanya tetap ditunggu di sini seperti semula.
     */
