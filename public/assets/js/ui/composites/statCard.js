...
export function StatCard({ label, value, note = "" }) {
  ...
  title.className = "text-[10px] font-semibold uppercase tracking-[0.16em] text-[var(--pb-brand-secondary)]";
  title.textContent = label;

  const number = document.createElement("strong");
  number.className = "block text-xl font-bold tracking-normal text-gray-950";
