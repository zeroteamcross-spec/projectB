...
function toastConfig(type = "info") {
  const map = {
    success: {
      title: "Berhasil",
      icon: "circleCheck",
      shell: "border-emerald-100/90 bg-[linear-gradient(135deg,rgba(255,255,255,0.98),rgba(236,253,245,0.94),rgba(240,253,250,0.90))]",
      accent: "bg-emerald-500",
      iconWrap: "border-emerald-100 text-emerald-600",
    },
    error: {
      title: "Gagal",
      ...
      accent: "bg-red-500",
      iconWrap: "border-red-100 text-red-600",
    },
    warning: {
      title: "Perhatian",
      icon: "triangleWarning",
      shell: "border-amber-100/90 bg-[linear-gradient(135deg,rgba(255,255,255,0.98),rgba(255,251,235,0.96),rgba(239,246,255,0.84))]",
      accent: "bg-amber-500",
      iconWrap: "border-amber-100 text-amber-600",
    },
    info: {
      title: "Informasi",
      icon: "info",
      ...
      accent: "bg-sky-500",
      iconWrap: "border-sky-100 text-sky-600",
    },
  };
